...
-   There was high variation in Michelson's measurements around a Temp
    of 70˚F.
...
-   VelocityVacuum has similar standard deviation for all 3 types of
    image qualities.
-   No, there are no patterns in the data that help explain the
