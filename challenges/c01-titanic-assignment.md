...
- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.
  - The fishy-ness in q4 was due to not separating by Age. The plot was
    showing the maximum out of the 2 different proportion values for 1st
    class adults and children. It can now be clearly seen in the 2
    different sub-plots.
