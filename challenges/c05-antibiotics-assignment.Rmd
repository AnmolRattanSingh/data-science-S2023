...
-   What is your response to the question above?
    ...
    -   Streptomycin has the least variation from bacteria to bacteria
        between the 3 antibiotics. But, Neomycin and Penicillin have
        some of the lowest MIC values between all 3 antibiotics even
        though they have higher variation than Streptomycin.

    -   Neomycin outperforms the other two antibiotics for most bacteria
        in given data.
...
-   Why?
    ...
    -   Visual 1 shows MIC values of all antibiotics for individual
        bacteria
