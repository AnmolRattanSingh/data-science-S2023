...
-   Was your sample size $n$ large enough? Why do you say that?
    -   I sampled 100000 points which I think should be large enough. Since this exercise is just for learning the monte carlo method and not for a critical use case it does not need to be extremely accurate.
