...
- Is there “one true value” for the material properties of Aluminum?
  - No, as seen in the summary of the data, the values of E and nu vary
    a lot.
- How many aluminum alloys are in this dataset? How do you know?
  - Only one al_2st with a count of 26. We know this since there is only
    one unique value in the alloy column.
- What angles were tested?
  - Angles tested were 0, 45, and 90 degrees.
- What thicknesses were tested?
  - Thicknesses tested were 0022, 0.032, 0.064, 0.081. (units not
    specified in data)
- How does E range over different thicknesses?
  - “E” ranges from 9900 to 10700 and has a mean of 10335. “thick”
    ranges from 0.02200 to 0.08100 and has a mean of 0.05215. We can
    create a plot of “E” vs “thick” to see if they correlate.
...
``` r
df_stang_long %>% 
  ggplot(aes(x = thick, y = E, color=nu)) + 
  geom_point()
```
...
- E has a weak negative correlation with the thickness. However it
  un-clear to spot it visually.
...
- Does this graph support or contradict the claim above?
  - The graph contradicts the statement above since thicker (more
    material) blocks have a higher modulus of elasticity. This does not
