...
- Does your interval include the true value of $\pi$?
  - Yes it does include the true value of $\pi$.
- What confidence level did you choose?
  - I picked a 95% confidence interval.
- Was your sample size $n$ large enough? Why do you say that?
  - I sampled 100000 points which I think should be large enough. Since
    this exercise is just for learning the monte carlo method and not
    for a critical use case it does not need to be extremely accurate.
