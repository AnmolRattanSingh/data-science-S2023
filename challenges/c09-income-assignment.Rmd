...
-   Document your observations here.
    -   The 2-person families do not have a lot of variation across different counties.
    -   5-person families in Nantucket have a wide confidence interval. That might be due a fewer number of 5-person families in Nantucket.
    -   The income of 2-person families is generally lower than 6-person families. This makes sense since larger families might have more people earning in the family.
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   No since the confidence intervals are overlapping a lot. This makes it hard to distinguish between different household incomes. For e.g. the 5-person families interval falls completely inside the 6-person families interval.
-   Which counties have the widest confidence intervals?
    -   Nantucket and Dukes have the widest confidence intervals for all categories.
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    -   As the population increases the `SE` tends to decrease. This might be due to an increase in the number of data points for the income estimate which leads to a decrease in the error.
-   What does this *overall* trend tell you about the relative ease of studying small vs large counties?
    -   It is easier to draw conclusions based on the data for larger counties since the error is lower. This does not necessarily mean that it is a better conclusion since it is easy to generalize for outliers in larger data sets.
...
(income rankings taken from [Wikipedia](https://en.wikipedia.org/wiki/List_of_lowest-income_counties_in_the_United_States))

**Observations**:

-   Lower income counties have larger confidence intervals compared to the higher income counties. This adds on to the standard error observation we made since the higher income counties also have a higher population.
-   The upper bound of the confidence intervals of the lowest income counties is almost equal to the lower bound of the confidence intervals of the highest income counties. This implies that the highest median income family of the lowest income counties is likely to fall under the lower end of incomes of the highest income counties.
-   Highest income counties follow the general trend of more-person families having a higher median income. This is not the case of the lowest income counties.
